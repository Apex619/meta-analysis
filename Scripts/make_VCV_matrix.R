...
#Making matrixes for my data

VmatCVR_all <- make_VCV_matrix(data = Effect_Size_All_Traits, V = "vi", cluster = "Control_ID", obs = "ES_ID")

VmatCVR_all_lnCVR <- make_VCV_matrix(data = Effect_Size_All_Traits_lnCVR, V = "vi", cluster = "Control_ID", obs = "ES_ID")

VmatCVR_MG <- make_VCV_matrix(data = MG_ALL, V = "vi", cluster = "Control_ID", obs = "ES_ID")

VmatCVR_OF <- make_VCV_matrix(data = OF_ALL, V = "vi", cluster = "Control_ID", obs = "ES_ID")

VmatCVR_MG_lnCVR <- make_VCV_matrix(data = MG_ALL_lnCVR, V = "vi", cluster = "Control_ID", obs = "ES_ID")

VmatCVR_OF_lnCVR <- make_VCV_matrix(data = OF_ALL_lnCVR, V = "vi", cluster = "Control_ID", obs = "ES_ID")