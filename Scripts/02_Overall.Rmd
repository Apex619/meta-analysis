...
<!-- ### Calculating control animals and treatment animals used -->

<!-- ```{r} -->
<!-- sum(ALL_TRAITS$Sample_Size_n_Treatment) -->

<!-- sum(ALL_TRAITS$Sample_Size_n_Control) -->
...
### Meta-analysis (Complete dataset)
Data is not split, and there are no moderators
```{r}
#ALL DATA
...
Overall <- I2_Hamza(All_Traits_Analysis_0mods)
Overall

#With Control_ID Matrix as "vi"

All_Traits_Analysis_0mods_matrix <- rma.mv(yi, VmatCVR_all, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=Effect_Size_All_Traits, method = 'REML')

All_Traits_Analysis_0mods_matrix
Overall <- I2_Hamza(All_Traits_Analysis_0mods_matrix)
Overall
#NOTES
#Yes, adding vi as a moderator is indeed the logical way of extending Egger's test to more complex models. Actually, using the sampling variances as a moderator is just one possibility of conducting the "regression test for funnel plot asymmetry". 
...
Regtest_Overall <- All_Traits_Analysis_0mods <- rma.mv(yi, vi, mod = vi, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=Effect_Size_All_Traits, method = 'REML')
Regtest_Overall
...
plot_lnRR_overall
```
## Overall Meta-regression for Traits and Exposure Type

I ran univariate meta-regression, first using trait as a moderator, and then exposure type as a moderator.
```{r}
...
All_Traits_Analysis_Exp <- rma.mv(yi, VmatCVR_all, mods= ~Exposure_Type, random = list(~1|Paper_ID,~1|Cohort_ID,~1|ES_ID,~1|Trait), data=Effect_Size_All_Traits, method = 'REML')

summary(All_Traits_Analysis_Exp)
anova(All_Traits_Analysis_Exp, L=c(0,-1))
funnel(All_Traits_Analysis_Exp,yaxis="seinv")
exp_regression_r2 <- R2(All_Traits_Analysis_Exp)
exp_regression_r2*100
...
Univariate analysis
```{r}
All_Data_Analysis_f0 <- rma.mv(yi, vi, mods = ~F0_Parent_Exposed, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=Effect_Size_All_Traits, method = 'REML')
...
```
## Overall meta-analysis subset by exposure type 
```{r}
...
mgi2 <- I2_Hamza(All_Data_Analysis_MG)
mgi2
anova(res, L=c(0,-1,1))
...
OF_i2 <- I2_Hamza(All_Data_Analysis_OF)
OF_i2
...
```
## Overall meta-analysis of traits (split by MG and OF datasets)
```{r}

#Overall analysis with moderators (by exposure type)
Traits_Analysis_MG <- rma.mv(yi, VmatCVR_MG, mods = ~Trait, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL, method = 'REML')

summary(Traits_Analysis_MG)
funnel(Traits_Analysis_MG,yaxis="seinv")
r2_traits <- R2(Traits_Analysis_MG)
r2_traits*100

k_traits_MG <- MG_ALL %>% group_by(Trait) %>% count()
k_traits_MG

Traits_Analysis_OF <- rma.mv(yi, VmatCVR_OF, mods = ~Trait, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL, method = 'REML')

summary(Traits_Analysis_OF)
funnel(Traits_Analysis_OF,yaxis="seinv")
r2oftraits <- R2(Traits_Analysis_OF)
r2oftraits*100

Traits_Analysis_OF1 <- rma.mv(yi, VmatCVR_OF, mods = ~relevel(Trait, 
    ref = "Body_Weight"), random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL, method = 'REML')
summary(Traits_Analysis_OF1)
...
## Overall meta-analysis of moderators (split by MG and OF datasets)

```{r}

#F0 and offspring sex analysis
All_Traits_Analysis_0mods_MG_f0 <- rma.mv(yi, VmatCVR_MG, mods = ~F0_Parent_Exposed, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL, method = 'REML')

summary(All_Traits_Analysis_0mods_MG_f0) #Run eggers regression
funnel(All_Traits_Analysis_0mods_MG_f0,yaxis="seinv")
k_f0mg <- MG_ALL %>% group_by(F0_Parent_Exposed) %>% count()
k_f0mg
r2fomg <- R2(All_Traits_Analysis_0mods_MG_f0)
r2fomg*100
est <- get_est(All_Traits_Analysis_0mods_MG_f0)
est

All_Traits_Analysis_0mods_OF_f0 <- rma.mv(yi, VmatCVR_OF, mods = ~F0_Parent_Exposed-1, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL, method = 'REML')

summary(All_Traits_Analysis_0mods_OF_f0)
funnel(All_Traits_Analysis_0mods_OF_f0,yaxis="seinv")
r2off0 <- R2(All_Traits_Analysis_0mods_OF_f0)
r2off0*100
k_f0of <- OF_ALL %>% group_by(F0_Parent_Exposed) %>% count()
k_f0of

All_Traits_Analysis_0mods_MG_sex <- rma.mv(yi, VmatCVR_MG, mods = ~Sex, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL, method = 'REML')

summary(All_Traits_Analysis_0mods_MG_sex)
funnel(All_Traits_Analysis_0mods_MG_sex,yaxis="seinv")
MG_ALL %>% group_by(Sex) %>% count()
r2mgsex <- R2(All_Traits_Analysis_0mods_MG_sex)
r2mgsex*100

All_Traits_Analysis_0mods_OF_sex <- rma.mv(yi, VmatCVR_OF, mods = ~Sex, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL, method = 'REML')

summary(All_Traits_Analysis_0mods_OF_sex)
funnel(All_Traits_Analysis_0mods_OF_sex,yaxis="seinv")
k_sexof <- OF_ALL %>% group_by(Sex) %>% count()
k_sexof
r2sexof <- R2(All_Traits_Analysis_0mods_OF_sex)
r2sexof*100
...
## Overall meta-analysis lnCVR (not split, no moderators)
```{r}
#ALL DATA

All_Traits_Analysis_0mods_lnCVR <- rma.mv(yi, VmatCVR_all_lnCVR, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=Effect_Size_All_Traits_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_lnCVR)
funnel(All_Traits_Analysis_0mods_lnCVR,yaxis="seinv")
overall_lncvr_i2 <- I2_Hamza(All_Traits_Analysis_0mods_lnCVR)
overall_lncvr_i2
...
#Exposure type meta-regression
All_Traits_Analysis_Exp_lnCVR <- rma.mv(yi, VmatCVR_all_lnCVR, mods= ~Exposure_Type-1, random = list(~1|Trait,~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=Effect_Size_All_Traits_lnCVR, method = 'REML')
...
```
## Meta-analysis with subsetted dataset (MG and OF exposure type) lnCVR
```{r}

#Overall analysis split by exposure type
All_Data_Analysis_MG_lnCVR <- rma.mv(yi, VmatCVR_MG_lnCVR, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL_lnCVR, method = 'REML')

summary(All_Data_Analysis_MG_lnCVR)
funnel(All_Data_Analysis_MG_lnCVR,yaxis="seinv")
I2mglncvr <- I2_Hamza(All_Data_Analysis_MG_lnCVR)
I2mglncvr
...
All_Data_Analysis_OF_lnCVR <- rma.mv(yi, VmatCVR_OF_lnCVR, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL_lnCVR, method = 'REML')

summary(All_Data_Analysis_OF_lnCVR)
funnel(All_Data_Analysis_OF_lnCVR,yaxis="seinv")
oflncvr <- I2_Hamza(All_Data_Analysis_OF_lnCVR)
oflncvr
...
```
## Overall analysis with moderators (by exposure type) lnCVR
```{r}


Traits_Analysis_MG_lnCVR <- rma.mv(yi, VmatCVR_MG_lnCVR, mods = ~Trait, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL_lnCVR, method = 'REML')
...
# I2_Trait_MG_lnCVR
# I2(Traits_Analysis_MG_lnCVR)

k_traits_MG_lnCVR <- MG_ALL_lnCVR %>% group_by(Trait) %>% count()
k_traits_MG_lnCVR

Traits_Analysis_OF_lnCVR <- rma.mv(yi, VmatCVR_OF_lnCVR, mods = ~Trait, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL_lnCVR, method = 'REML')

summary(Traits_Analysis_OF_lnCVR)
funnel(Traits_Analysis_OF_lnCVR,yaxis="seinv")
r2lncvroftraits <- R2(Traits_Analysis_OF_lnCVR)
r2lncvroftraits*100
...
#F0 and offspring sex analysis
All_Traits_Analysis_0mods_MG_f0_lnCVR <- rma.mv(yi, VmatCVR_MG_lnCVR, mods = ~F0_Parent_Exposed, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_MG_f0_lnCVR)
funnel(All_Traits_Analysis_0mods_MG_f0_lnCVR,yaxis="seinv")
mgf0lncvrr2 <- R2(All_Traits_Analysis_0mods_MG_f0_lnCVR)
mgf0lncvrr2*100


All_Traits_Analysis_0mods_OF_f0_lnCVR <- rma.mv(yi, VmatCVR_OF_lnCVR, mods = ~F0_Parent_Exposed, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_OF_f0_lnCVR)
funnel(All_Traits_Analysis_0mods_OF_f0_lnCVR,yaxis="seinv")
fooflncvrr2 <- R2(All_Traits_Analysis_0mods_OF_f0_lnCVR)
fooflncvrr2*100
k_traits_off0 <- OF_ALL_lnCVR %>% group_by(F0_Parent_Exposed) %>% count()
k_traits_off0

All_Traits_Analysis_0mods_MG_sex_lnCVR <- rma.mv(yi, VmatCVR_MG_lnCVR, mods = ~Sex, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_MG_sex_lnCVR)
funnel(All_Traits_Analysis_0mods_MG_sex,yaxis="seinv")
r2lncvrmgsex <- R2(All_Traits_Analysis_0mods_MG_sex_lnCVR)
r2lncvrmgsex*100

All_Traits_Analysis_0mods_OF_sex_lnCVR <- rma.mv(yi, VmatCVR_OF_lnCVR, mods = ~Sex, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_OF_sex_lnCVR)
  funnel(All_Traits_Analysis_0mods_OF_sex_lnCVR,yaxis="seinv")
  r2lncvrofsex <- R2(All_Traits_Analysis_0mods_OF_sex_lnCVR)
