...
### Meta-regression model on all data with Rodent_type (comapere MA intercepts)  
...
save(MR_all_RodT_lnRR, file = here("Rdata/MR_all_RodT_lnRR.Rdata"))
...
save(MR_all_RodT_lnRRi, file = here("Rdata/MR_all_RodT_lnRRi.Rdata"))
...
save(MR_all_RodT_lnCVR, file = here("Rdata/MR_all_RodT_lnCVR.Rdata"))
...
save(MR_all_RodT_lnCVRi, file = here("Rdata/MR_all_RodT_lnCVRi.Rdata"))
...
save(MR_OF_Rodent_lnRRr, file = here("Rdata/MR_OF_Rodent_lnRRr.Rdata"))
...
summary(MR_OF_Rodent_lnCVRr)    
save(MR_OF_Rodent_lnCVRr, file = here("Rdata/MR_OF_Rodent_lnCVRr.Rdata"))
...
## MG lnRR - ref Rat
MR_MG_Rodent_lnRRr <- rma.mv(lnRR, Vmat_lnRR_MG, mods= ~relevel(data_MG$Rodent_Type, ref="Rat"), random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = data_MG, method = "REML") 
summary(MR_MG_Rodent_lnRRr)    
save(MR_MG_Rodent_lnRRr, file = here("Rdata/MR_MG_Rodent_lnRRr.Rdata"))
...
## MG lnCVR - ref Rat
MR_MG_Rodent_lnCVRr <- rma.mv(lnCVR, Vmat_lnCVR_MG, mods= ~relevel(data_MG$Rodent_Type, ref="Rat"), random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = data_MG, method = "REML") 
summary(MR_MG_Rodent_lnCVRr)    
save(MR_MG_Rodent_lnCVRr, file = here("Rdata/MR_MG_Rodent_lnCVRr.Rdata"))
