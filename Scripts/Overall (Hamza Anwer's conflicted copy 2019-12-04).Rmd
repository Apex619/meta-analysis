...
Overall_Exp_lnRR <- tibble(
  Exposure_Type = c("Multigenerational", "One off"), 
  lnRR = c(All_Data_Analysis_MG$b[1],All_Data_Analysis_OF$b[2]),
  ci.lb = c(All_Data_Analysis_MG$ci.lb[1],All_Data_Analysis_OF$ci.lb[2]),
  ci.ub = c(All_Data_Analysis_MG$ci.ub[1],All_Data_Analysis_OF$ci.ub[2]),
  k = c(118,223)
)
Overall_Exp_lnRR
