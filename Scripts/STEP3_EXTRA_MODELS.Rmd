...
data_F0 <- read_excel("../Data/ALL_TRAITS_20200514_REVISED.xlsx", sheet = "F0")
...
R2(before_pregnancy_sex_intercepts)
...
R2(before_pregnancy_sex_intercepts_lnCVR)
...
before_pregnancy_OF <- data_OF %>% filter(Treatment_Start_F0 <= "0", Treatment_End_F0 == "0", F0_Parent_Exposed != "Both") #subset

before_pregnancy_OF <- droplevels(before_pregnancy_OF)
...
R2(before_pregnancy_sex_intercepts_of)
...
R2(before_pregnancy_sex_intercepts_of_lnCVR)
...
#MG Models, filter and subset data
...
df$devel_period <- as.factor(df$devel_period) #convert to factor
...
R2(females_devel_periods_intercepts)
...
#contrasts model relevelled for bda (before, during after) lnRR
females_devel_periods_contrast_bda_mg <- rma.mv(lnRR, Vmat_lnRR_MG_females, mods= ~relevel(df$devel_period, ref="before, during and after pregnancy"), random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df, method = "REML")

summary(females_devel_periods_contrast_bda_mg)
...
R2(females_devel_periods_intercepts_lnCVR)
...
#contrasts model relevelled for bda lnCVR
females_devel_periods_contrast_lnCVR_bda_mg <- rma.mv(lnCVR, Vmat_lnCVR_MG_females, mods= ~relevel(df$devel_period, ref = "before, during and after pregnancy"), random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df, method = "REML")

summary(females_devel_periods_contrast_lnCVR_bda_mg)

#OF Models, filter and subset data

before_pregnancy_OF_females <- data_OF %>% filter(Treatment_Start_F0 <= "0", Treatment_End_F0 == "0", F0_Parent_Exposed == "Female") %>% mutate(devel_period = "before pregnancy") 

before_during_and_after_pregnancy_OF_females <- data_OF %>% filter(Treatment_Start_F0 <= "0", Treatment_End_F0 > "0", F0_Parent_Exposed == "Female") %>% mutate(devel_period = "before, during and after pregnancy") 

during_and_after_pregnancy_OF_females <- data_OF %>% filter(Treatment_Start_F0 >= "0", Treatment_End_F0 > "0", F0_Parent_Exposed == "Female") %>% mutate(devel_period = "during and after pregnancy")


#bind rows 
df_OF <- bind_rows(before_pregnancy_OF_females,before_during_and_after_pregnancy_OF_females,during_and_after_pregnancy_OF_females)

str(df_OF)

df_OF$devel_period <- as.factor(df_OF$devel_period)


Vmat_lnRR_OF_females <- make_VCV_matrix(data = df_OF, V = "VlnRR", cluster = "Cohort_ID_Control", obs = "ES_ID") 

Vmat_lnCVR_OF_females <- make_VCV_matrix(data = df_OF, V = "VlnCVR", cluster = "Cohort_ID_Control", obs = "ES_ID") 

#intercepts model (females vs females during developmental periods) lnRR
females_devel_periods_intercepts_OF <- rma.mv(lnRR, Vmat_lnRR_OF_females, mods= ~devel_period - 1, random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df_OF, method = "REML")

summary(females_devel_periods_intercepts_OF)

R2(females_devel_periods_intercepts_OF)

#contrasts model (females vs females during developmental periods) lnRR
females_devel_periods_contrast_OF <- rma.mv(lnRR, Vmat_lnRR_OF_females, mods= ~devel_period, random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df_OF, method = "REML")

summary(females_devel_periods_contrast_OF)

#relevelled for before, during and after (OF lnRR)
females_devel_periods_contrast_OF_bda <- rma.mv(lnRR, Vmat_lnRR_OF_females, mods= ~relevel(df_OF$devel_period, ref="before, during and after pregnancy"), random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df_OF, method = "REML")

summary(females_devel_periods_contrast_OF_bda)

#intercepts model (females vs females during developmental periods) lnCVR
females_devel_periods_intercepts_lnCVR_OF <- rma.mv(lnCVR, Vmat_lnCVR_OF_females, mods= ~devel_period - 1, random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df_OF, method = "REML")

summary(females_devel_periods_intercepts_lnCVR_OF)

R2(females_devel_periods_intercepts_lnCVR_OF)

#contrasts model (females vs females during developmental periods) lnCVR
females_devel_periods_contrast_lnCVR_OF <- rma.mv(lnCVR, Vmat_lnCVR_OF_females, mods= ~devel_period, random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df_OF, method = "REML")

summary(females_devel_periods_contrast_lnCVR_OF)

#contrasts model relevelled for bda lnCVR
females_devel_periods_contrast_lnCVR_OF_bda <- rma.mv(lnCVR, Vmat_lnCVR_OF_females, mods= ~relevel(df_OF$devel_period, ref="before, during and after pregnancy"), random = list(~1|Rodent_Strain, ~1|Study_ID,  ~1|Trait, ~1|ES_ID), data = df_OF, method = "REML")

summary(females_devel_periods_contrast_lnCVR_OF_bda)
