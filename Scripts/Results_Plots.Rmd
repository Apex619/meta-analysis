...
```{r}
Traits_Joined_OF <- Traits_Analysis_OF_orchard + Traits_Analysis_OF_orchard_lnCVR + plot_layout(ncol=2,nrow = 2)
Traits_Joined_MG <- Traits_Analysis_MG_orchard + Traits_Analysis_MG_orchard_lnCVR + plot_layout(ncol=2,nrow = 2)
Traits_Joined_OF
ggsave("Traits_OF.jpg", width = 20, height = 16, units = "cm")
...
ggsave("Traits.pdf", width = 25, height = 20, units = "cm", device = cairo_pdf)
ggsave("Traits.jpg", width = 25, height = 20, units = "cm")
