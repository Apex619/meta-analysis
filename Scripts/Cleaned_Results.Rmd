...
Overall_effects_not_split <- tibble(
  ...
  lnRR = c(All_Data_Analysis_Exp_Type$b[1],All_Data_Analysis_Exp_Type$b[2],All_Data_Analysis_f0$b[1],All_Data_Analysis_f0$b[2],All_Data_Analysis_f0$b[3],All_Data_Analysis_sex$b[1],All_Data_Analysis_sex$b[2],All_Data_Analysis_sex$b[3]),
  ci.lb = c(All_Data_Analysis_Exp_Type$ci.lb[1],All_Data_Analysis_Exp_Type$ci.lb[2],All_Data_Analysis_f0$ci.lb[1],All_Data_Analysis_f0$ci.lb[2],All_Data_Analysis_f0$ci.lb[3],All_Data_Analysis_sex$ci.lb[1],All_Data_Analysis_sex$ci.lb[2],All_Data_Analysis_sex$ci.lb[3]),
  ci.ub = c(All_Data_Analysis_Exp_Type$ci.ub[1],All_Data_Analysis_Exp_Type$ci.ub[2],All_Data_Analysis_f0$ci.ub[1],All_Data_Analysis_f0$ci.ub[2],All_Data_Analysis_f0$ci.ub[3],All_Data_Analysis_sex$ci.ub[1],All_Data_Analysis_sex$ci.ub[2],All_Data_Analysis_sex$ci.ub[3])
)
