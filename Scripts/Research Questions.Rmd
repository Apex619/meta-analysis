...
df <- data.frame(
  group = c("Adiposity", "Body Weight", "Glucose", "Insulin", "Leptin", "Triglycerides"),
  value = c(65, 146, 40, 45, 12, 33)
  )
head(df)
...
library(expss)
ALL_TRAITS = apply_labels(ALL_TRAITS,
                          Trait = "Trait",
                          Rodent_type = "Rodent",
                          Strain = "Strain",
                          F0_Parent_Exposed = "F0 Parent Exposed",
                          Sex = "Sex",
                          Exposure_Type = "Exposure type"
)
cro(ALL_TRAITS$Trait, ALL_TRAITS$Exposure_Type)
```
