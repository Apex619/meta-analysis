---
title: "Transgenerational effects of an obesogenic diet on aspects of physiology: a meta-analysis"
author: "Hamza Anwer"
...
Regression coefficients (Estimate), 95% confidence intervals (CIs), variance components (V) and variance explained, *R*^2^~[marginal]~ (R2) from the meta-regression with `symbiosis`. 
...
Regression coefficients (Estimate), 95% confidence intervals (CIs), variance components (V) and variance explained, *R*^2^~[marginal]~ (R2) from the meta-regression with `symbiosis` (compare the effect estiamtes in **Supplementary Table 2** with the corresponding values in this table). 
...
Regression coefficients (Estimate), 95% confidence intervals (CIs), variance components (V) and variance explained, *R*^2^~[marginal]~ (R2) from the meta-regression with `host_tax_broad`(compare the effect estiamtes in **Supplementary Table 3** with the corresponding values in this table). 
...
Regression coefficients (Estimate), 95% confidence intervals (CIs), variance components (V) and variance explained, *R*^2^~[marginal]~ (R2) from the meta-regression with `mode_of_transmission_broad` (compare the effect estiamtes in **Supplementary Table 8** with the corresponding values in this table).. 
