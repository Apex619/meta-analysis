...
Traits_Analysis_MG <- rma.mv(yi, VmatCVR_MG, mods = ~Trait-1, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL, method = 'REML')

summary(Traits_Analysis_MG)
funnel(Traits_Analysis_MG,yaxis="seinv")
I2_Trait_MG <- I2_Hamza(Traits_Analysis_MG)
I2_Trait_MG

k_traits_MG <- MG_ALL %>% group_by(Trait) %>% count()
k_traits_MG

Traits_Analysis_OF <- rma.mv(yi, VmatCVR_OF, mods = ~Trait-1, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL, method = 'REML')

summary(Traits_Analysis_OF)
funnel(Traits_Analysis_OF,yaxis="seinv")
I2_Traits_OF <- I2_Hamza(Traits_Analysis_OF)
I2_Traits_OF
...
All_Traits_Analysis_0mods_MG_f0 <- rma.mv(yi, VmatCVR_MG, mods = ~F0_Parent_Exposed-1, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL, method = 'REML')

summary(All_Traits_Analysis_0mods_MG_f0) #Run eggers regression
funnel(All_Traits_Analysis_0mods_MG_f0,yaxis="seinv")
I2_MG_F0 <- I2_Hamza(All_Traits_Analysis_0mods_MG_f0)
I2_MG_F0
...
I2_OF_F0 <- I2_Hamza(All_Traits_Analysis_0mods_OF_f0)
I2_OF_F0
...
I2_MG_sex <- I2_Hamza(All_Traits_Analysis_0mods_MG_sex)
I2_MG_sex
...
I2_OF_sex <- I2_Hamza(All_Traits_Analysis_0mods_OF_sex)
I2_OF_sex
...
Traits_Analysis_MG_lnCVR <- rma.mv(yi, VmatCVR_MG_lnCVR, mods = ~Trait-1, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL_lnCVR, method = 'REML')
...
Traits_Analysis_OF_lnCVR <- rma.mv(yi, VmatCVR_OF_lnCVR, mods = ~Trait-1, random = list( ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL_lnCVR, method = 'REML')
...
#F0 and offspring sex analysis
All_Traits_Analysis_0mods_MG_f0_lnCVR <- rma.mv(yi, VmatCVR_MG_lnCVR, mods = ~F0_Parent_Exposed-1, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_MG_f0_lnCVR)
funnel(All_Traits_Analysis_0mods_MG_f0_lnCVR,yaxis="seinv")

All_Traits_Analysis_0mods_OF_f0_lnCVR <- rma.mv(yi, VmatCVR_OF_lnCVR, mods = ~F0_Parent_Exposed-1, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_OF_f0_lnCVR)
funnel(All_Traits_Analysis_0mods_OF_f0_lnCVR,yaxis="seinv")

All_Traits_Analysis_0mods_MG_sex_lnCVR <- rma.mv(yi, VmatCVR_MG_lnCVR, mods = ~Sex-1, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=MG_ALL_lnCVR, method = 'REML')

summary(All_Traits_Analysis_0mods_MG_sex_lnCVR)
funnel(All_Traits_Analysis_0mods_MG_sex,yaxis="seinv")


All_Traits_Analysis_0mods_OF_sex_lnCVR <- rma.mv(yi, VmatCVR_OF_lnCVR, mods = ~Sex-1, random = list(~1|Trait, ~1|Paper_ID,~1|Cohort_ID,~1|ES_ID), data=OF_ALL_lnCVR, method = 'REML')
